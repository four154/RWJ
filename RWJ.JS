var rid='192a1630fbcxdd1316f6-xcuf886';
...
$(`<style>
.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886 .fitimg.u-pic.borderg {
  letter-spacing: 1px;
  background-size: 108% 108%;
  -webkit-text-fill-color: white;
  animation: grad 2s cubic-bezier(.445,.05,.55,.95) alternate infinite;
}
.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886 .corner.fa.fa-user.label.uc.fa-microphone.label-danger {
  letter-spacing: 1px;
...
.nosel.d-flex.r192a1630fbcxdd1316f6-xcuf886.bord {border-inline: 0px solid #4c121e !important;}
.nosel.d-flex.r192a1630fbcxdd1316f6-xcuf886 .dots.mini.u-msg {
    text-align: center;
...
.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886 {
    background-image: url(https://up6.cc/2024/10/172928556497284.gif);
    background-size: cover;
    border-radius: 15px 0px 15px 0px;
    display: inline-block;
}
.nosel.d-flex.r192a1630fbcxdd1316f6-xcuf886 .fitimg.u-pic.borderg {
  border-radius: 100px;
...
.nosel.d-flex.room.r192a1630fbcxdd1316f6-xcuf886 .u-topic.dots {
...
#d2.l7dah1 .label-primary{background-color:#b77c9a!important}#d2.l7dah1 .bg{background-color:#b77c9a!important}#d2.l7dah1 .uzr.d-flex.mm.hmsg{border-radius: 10px 0 10px;background-color: #3426231f!important;}#dpnl.l7dah1{background-size: 100%;background-image: url(https://up6.cc/2024/10/17292854193624.png);background-color: #b2b2b2;  }#dpnl.l7dah1 .light{background-color:#ecdce4!important;background-image:linear-gradient(225deg,#dfdfdf 0%,#f7f7f7 29%,#f4f4f4 67%,#dbdbdb 100%);}#d0.l7dah1 .nosel.fl.bg.{background-color:#b77c9a!important;  }#users.l7dah1 span.uhash{text-transform:uppercase;background-image:linear-gradient(-225deg,#7b7b7b 0,#737373 29%,#ebebeb 67%,#3600ff 100%);background-size:220% auto;-webkit-background-clip:text;-webkit-text-fill-color:transparent;animation:2s linear infinite textclip;display:inline-block}
...
#d0.l7dah1 .label-primary {
    ...
    border-radius: 10px 0 10px!important;
    background-image: url(https://up6.cc/2024/10/17292836679121.png);
    color: #ffffff;
    background-size: 100%;
}
...
#upro.l7dah1 .light.fl.pro.break {
    ...
    background-image: url(https://up6.cc/2024/10/17292854638814.png);
    background-size: 100%;
}
#mic.l7dah1 #muteall {
    border-radius: 10px 0 10px;
...
setInterval(function () {
    if (myroom == '192a1630fbcxdd1316f6-xcuf886') {
        if (l7dah == false) {
            l7dah = true;
